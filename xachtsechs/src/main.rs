...
const BIOS_SYSTEM_TIMER_COUNTER_ADDR_U32: u32 = BIOS_START + 0x6c;
const BIOS_SYSTEM_TIMER_COUNTER_LOW: DataLocation16 = bios_off_u16(0x6c);
const BIOS_SYSTEM_TIMER_COUNTER_HIGH: DataLocation16 = bios_off_u16(0x6e);
